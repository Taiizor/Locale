...
namespace Locale.CLI;

/// <summary>
/// Provides the entry point and configuration for the Locale CLI application, a multi-format localization toolkit.
/// </summary>
/// <remarks>This class is responsible for initializing the application's console encoding, displaying branding
/// information, and configuring the command-line interface, including available commands and help styles. It sets up
/// the application's culture, versioning, and command registration for localization-related operations such as
/// scanning, diffing, checking, converting, generating, watching, and translating localization files. This class is not
/// intended to be instantiated or inherited.</remarks>
